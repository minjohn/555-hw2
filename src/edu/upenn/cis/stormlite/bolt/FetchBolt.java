...
public class FetchBolt implements IRichBolt{
	...
	CrawlerRequester requester;

	String executorId = UUID.randomUUID().toString();


	// constructor
	//public FetchBolt(WebsiteRecord webrecord){
	public FetchBolt(){
	...
	public void execute(Tuple input) {
		...
		HashMap<String, Date> seenUrls = WebsiteRecord.seenUrls;
		HashMap<String, RobotsTxtInfo> hostRobotsMap = WebsiteRecord.hostRobotsMap;
